""" following program performs Naiv bayes (GaussianNB) algorithm of machine learning for the dataset Mnits 
...
# convert 3D in 2D without losing information, because of StandardScaler and pca process 
...
"""  note: parameter list (as dic) builds different possible combinatorial parameter pairss
            Depending on the computing capacity, can several parameters be included in the optimization process. 
"""""
# train a GaussianNB Classifier model
param_grid = {
...
clf = RandomizedSearchCV( GaussianNB() , param_grid, n_iter=18 )
